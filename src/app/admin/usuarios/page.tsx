                            ...
                            {usuarios.map((usuario) => (
                                <tr key={usuario.idUsuario} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 text-sm">
                                        <span
                                            className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${usuario.estado
                                    ...
                                    <td className="px-4 py-3 text-sm">
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <button
                                                ...
                                                className={`rounded px-3 py-1 text-xs font-medium text-white ${usuario.estado
