...
// Esquema de validación SIN pronóstico del tiempo
...
// GET /api/planes-accion - Listar planes de acción (con filtro por incidente)
...
// POST /api/planes-accion - Crear un nuevo plan de acción
export async function POST(request: NextRequest) {
  try {
    ...
    // Verificar que el periodo operacional existe y pertenece al incidente
    ...
    // Verificar que no exista un PAI para este periodo (relación 1:1)
